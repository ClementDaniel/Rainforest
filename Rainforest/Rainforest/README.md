# Rainforest API - AWS ECS Fargate Deployment
...
```bash
# Setup S3 backend
terraform init -backend-config="bucket=rainforest"
```
...
3. GitHub repository allows Actions and Environments
4. Cost considerations favoring simplicity over redundancy for demo
